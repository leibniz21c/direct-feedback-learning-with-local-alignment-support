...
class ResNet(bcnn.Module):
    ...
    def fit(self, data, label, criteria, optimizer):
        ...
        local_loss_layer1_block1_conv1 = criteria[0](local_output_layer1_block1_conv1, global_out); local_loss_layer1_block1_conv1.backward()
        local_loss_layer2_block1_conv1 = criteria[0](local_output_layer2_block1_conv1, global_out); local_loss_layer2_block1_conv1.backward()
        local_loss_layer3_block1_conv1 = criteria[0](local_output_layer3_block1_conv1, global_out); local_loss_layer3_block1_conv1.backward()
        local_loss_layer4_block1_conv1 = criteria[0](local_output_layer4_block1_conv1, global_out); local_loss_layer4_block1_conv1.backward()
        optimizer.step()
...
class LAS_RESNET18_CIFAR10(ResNet):
    def __init__(self):
        super(LAS_RESNET18_CIFAR10, self).__init__(num_classes=10)


class LAS_RESNET18_CIFAR100(ResNet):
    def __init__(self):
        super(LAS_RESNET18_CIFAR100, self).__init__(num_classes=100)


class LAS_RESNET18_TINYIMAGENET(ResNet):
    def __init__(self):
        super(LAS_RESNET18_TINYIMAGENET, self).__init__(num_classes=200)