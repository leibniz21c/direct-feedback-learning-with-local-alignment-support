...
class Conv(bcnn.Module):
    ...
    def fit(self, data, label, criteria, optimizer):
        # global flow update
        optimizer.zero_grad()
        local_output1, local_output2, local_output3, local_output4, global_output = self.forward(data, get_local_output=True)
        local_loss1, local_loss2, local_loss3, local_loss4 = (
            criteria[0](local_output1, global_output),
            criteria[0](local_output2, global_output),
            criteria[0](local_output3, global_output),
            criteria[0](local_output4, global_output),
        )
...
class LAS_CONV_CIFAR10(Conv):
    def __init__(self):
        super(LAS_CONV_CIFAR10, self).__init__(num_classes=10)


class LAS_CONV_CIFAR100(Conv):
    def __init__(self):
        super(LAS_CONV_CIFAR100, self).__init__(num_classes=100)


class LAS_CONVBN_CIFAR10(ConvBN):
    def __init__(self):
        super(LAS_CONVBN_CIFAR10, self).__init__(num_classes=10)


class LAS_CONVBN_CIFAR100(ConvBN):
    def __init__(self):
        super(LAS_CONVBN_CIFAR100, self).__init__(num_classes=100)
