...
class DFA_RESNET18_CIFAR10(ResNet):
    def __init__(self):
        super(DFA_RESNET18_CIFAR10, self).__init__(num_classes=10)


class DFA_RESNET18_CIFAR100(ResNet):
    def __init__(self):
        super(DFA_RESNET18_CIFAR100, self).__init__(num_classes=100)


class DFA_RESNET18_TINYIMAGENET(ResNet):
    def __init__(self):
        super(DFA_RESNET18_TINYIMAGENET, self).__init__(num_classes=200)